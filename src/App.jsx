  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50/10 via-stone-50/50 to-amber-100/30 text-stone-900 font-light overflow-hidden">
        ...
        <main>
            ...
            <section className="py-16"><div className="max-w-7xl mx-auto px-6"><div className="aspect-w-16 aspect-h-9"><iframe src="https://embed.screenapp.io/app/#/shared/Xn9POKRa2L?embed=true" title="Product Video" className="w-full h-full rounded-2xl shadow-xl" frameBorder="0" allowFullScreen></iframe></div></div></section>
